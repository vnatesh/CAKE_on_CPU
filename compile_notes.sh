...
gcc -DMKL_ILP64 -m64 -I${MKLROOT}/include test.c -Wl,--no-export-dynamic -Wl,--start-group \
${MKLROOT}/lib/intel64/libmkl_intel_ilp64.a ${MKLROOT}/lib/intel64/libmkl_gnu_thread.a \
${MKLROOT}/lib/intel64/libmkl_core.a /usr/lib/gcc/x86_64-linux-gnu/5/libgomp.a  \
...
-static /usr/lib/x86_64-linux-gnu/libm.a -o matmultest
